...
$sql = "SELECT td.*, COALESCE(CAST(ROUND(AVG(truck_rating.truck_rating)) AS INT), NULL) AS average_rating FROM truck_detials td LEFT JOIN truck_rating truck_rating ON td.truck_id = truck_rating.truck_id GROUP BY td.truck_id";
